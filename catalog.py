...
def callback(data, user, chat_id):
    if data[0] == 'all':
        ...
        msg = bot.send_message(chat_id=chat_id, text='Введите название сервиса, который хотите найти', reply_markup=buttons.go_to_menu())
        bot.register_next_step_handler(msg, filter_name, chat_id)
    elif data[0] == 'dont_find':
        # TODO: Добавить переадресацию на менеджера
        pass
    elif data[0] == 'detail':
